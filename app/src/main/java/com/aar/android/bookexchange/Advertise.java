...
public class Advertise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView locationTextView= findViewById(R.id.show_book_location);
        TextView conditionTextView=findViewById(R.id.show_book_condition);
        TextView exchangeTextView=findViewById(R.id.show_book_exchange);
        ...
        locationTextView.setText(myBook.getLocation());
        conditionTextView.setText(myBook.getCondition());
        exchangeTextView.setText(myBook.getExchange());
